...
var terrainUniforms = {
    ...
    uSplat1Repeat: { type: "v2", value: new THREE.Vector2(5120.0, 5120.0) },
    uSplat2Repeat: { type: "v2", value: new THREE.Vector2(5120.0, 5120.0) },
    uSplat3Repeat: { type: "v2", value: new THREE.Vector2(5120.0, 5120.0) },
    uSplat4Repeat: { type: "v2", value: new THREE.Vector2(5120.0, 5120.0) },
...
"        splat3 * alphaMap.b + splat4 * alphaMap.a;",
    ...
    "vec3 dirSpecular = vec3( 3.0 );" ,

    "vec4 lDirection = viewMatrix * vec4( directionalLightDirection[ 0 ], 4.0 );",
